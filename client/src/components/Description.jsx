      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-4">
            ...
            Whether you need stunning visuals oe unique imagery, our tool
          ...
          <p>
            ...
            high-quality images in seconds. From products visuals to character
            designs ans portraits , even concepts that don't yet exist can be
            visualized effortlessly. Powered by advanced AI technology, the
            creative possibilities and limitless
          </p>
        </div>
      </div>
    </motion.div>
